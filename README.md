...
<div style="display: flex; flex-wrap: wrap; gap: 5px;">
    ...
    <img src="6.jpg" alt="Изображение 4" width="375" style="flex: 1 1 calc(33% - 10px);"/>
    <div>
     <img src="3.jpg" alt="Изображение 5" width="375" style="flex: 1 1 calc(33% - 10px);"/>
    <img src="4.jpg" alt="Изображение 6" width="375" style="flex: 1 1 calc(33% - 10px);"/>
    </div>
</div>
